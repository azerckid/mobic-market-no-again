    ...
    <div className="px-4 py-10">
      <div className="mb-8">
        ...
        <div className="mt-10">
          ...
          <p className="text-base my-6 text-gray-700 first-letter:font-bold first-letter:text-2xl">
          ...
          <div className="flex items-center justify-between space-x-2">
            <button className="flex-1 bg-teal-500 text-white py-3 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 hover:bg-pink-500">
              Talk to seller
            </button>
            <button className="p-3 flex items-center justify-center text-gray-500">
              <svg
                className="h-6 w-6 "
      ...
      <div>
        ...
        <div className="mt-6 grid grid-cols-2 gap-4">
          {[...Array(6)].map((_, i) => (
            <div key={i}>
              <div className="h-56 bg-orange-300" />
